...
class AbsDataset():
    def __init__(self, max_antibody_len=344, max_virus_len=912,
        ...
        print("DatasetName: ", self.dataset_name)
        print("Last:", self.dataset_param_str+'__protein_ft_dict.pkl')
        self.protein_ft_save_path = osp.join(current_path, processed_dir, self.dataset_param_str+'__protein_ft_dict.pkl')
        print("Complete path:", self.protein_ft_save_path)
        ...
        self.all_label_mat = np.load(osp.join(current_path, corpus_dir, 'all_label_mat.npy'))  # 1: ic50<10,  0: ic50>=10
