...
class DeepAAIKmerPssmEmbeddingCls(nn.Module):
    def __init__(self, **param_dict):
        ...
        ## test
        # print('layer dim -----------------------')
        # print("kmer_dim: ", param_dict['kmer_dim'])
        # print("h_dim: ", self.h_dim)
        # print("pssm_antibody_dim: ", param_dict['pssm_antibody_dim'])   
        # print("pssm_virus_dim: ", param_dict['pssm_virus_dim'])      
        # print('---------------------------------')  
    ...
    def forward(self, **ft_dict):
        ...
        ## test
        print("dims -------------------------")
        # print("antibody: ", antibody_graph_node_num)
        # print("virus: ", virus_graph_node_num)
        ...
        # print("kmer_ft: ", ft_dict['antibody_graph_node_kmer_ft'].size())
        # print("pssm_ft: ", ft_dict['antibody_graph_node_pssm_ft'].size())
        ...
        # print("node_ft(cat): ", antibody_node_ft.size())
        ...
        # print("antibody_res_mat: ", antibody_res_mat.size())

        # cross
        global_pair_ft = torch.cat([virus_res_mat, antibody_res_mat], dim=1)
        print("global_pair_ft: ", global_pair_ft.size())
        ...
        print("virus_amino_ft: ", ft_dict['virus_amino_ft'].view(batch_size, -1).size())
        print("antibody_amino_ft: ", ft_dict['antibody_amino_ft'].view(batch_size, -1).size())
        ...
        print("local_pair_ft: ", local_pair_ft.size())
